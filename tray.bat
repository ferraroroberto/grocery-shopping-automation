...
chcp 65001 >nul
REM ============================================================================
REM  grocery-shopping-automation TRAY - tray icon that owns a long-lived service lifecycle
REM ----------------------------------------------------------------------------
...
REM
REM  Idempotent:
REM    tray.bat              -> no-op if a grocery-shopping-automation tray is already running
...
REM  the owned-ports reclaim list -- reclaiming one would kill the sibling.
REM ============================================================================
...
set "APP_NAME=grocery-shopping-automation"
